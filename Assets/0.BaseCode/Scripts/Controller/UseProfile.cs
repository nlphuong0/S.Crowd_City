...
public class UseProfile : MonoBehaviour
{
    ...
    public static int RedoBooster
    {
        get
        {
            return PlayerPrefs.GetInt(StringHelper.REDO_BOOSTER, 5);
        }
        set
        {
            PlayerPrefs.SetInt(StringHelper.REDO_BOOSTER, value);
            PlayerPrefs.Save();
            EventDispatcher.EventDispatcher.Instance.PostEvent(EventID.CHANGE_REDO_BOOSTER);
        }
    }
    public static int SuportBooster
    {
        get
        {
            return PlayerPrefs.GetInt(StringHelper.SUPORT_BOOSTER, 5);
        }
        set
        {
            PlayerPrefs.SetInt(StringHelper.SUPORT_BOOSTER, value);
            PlayerPrefs.Save();
            EventDispatcher.EventDispatcher.Instance.PostEvent(EventID.CHANGE_SUPORT_BOOSTER);
        }
    }
